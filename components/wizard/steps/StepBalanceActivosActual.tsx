  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-5">
        <CampoMoneda label="Cartera Neta" ayuda="Cuentas por cobrar a clientes" valor={d.carteraNeta} onChange={(v) => updateDatosActual('carteraNeta', v)} autoFocus />
        <CampoMoneda label="Inventarios" ayuda="Mercancía o materia prima en bodega" valor={d.inventarios} onChange={(v) => updateDatosActual('inventarios', v)} />
        <CampoMoneda label="Activos Fijos Netos" ayuda="Maquinaria, equipos, propiedades (descontada depreciación)" valor={d.activosFijosNetos} onChange={(v) => updateDatosActual('activosFijosNetos', v)} />
