  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h2 className="text-2xl font-bold text-prestigio-900">¿Qué años vamos a analizar?</h2>
        <p className="text-gray-500">
          La servilleta compara dos períodos para ver la evolución de tu empresa
        </p>
      </div>

      <div className="bg-prestigio-50 rounded-2xl p-4 border border-prestigio-200">
        <p className="text-sm text-prestigio-700">
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <select
            ...
            className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-base focus:border-prestigio-700 focus:outline-none transition-colors bg-white"
          >
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 bg-prestigio-50 border border-prestigio-200 rounded-xl p-4 text-center">
          <p className="text-xs text-prestigio-500 mb-1">Período 2</p>
          <p className="text-2xl font-bold text-prestigio-700">{anioActual}</p>
          <p className="text-xs text-prestigio-400 mt-1">Año actual</p>
        </div>
      </div>

      <button
        onClick={onNext}
        className="w-full bg-prestigio-900 hover:bg-prestigio-800 text-white font-bold py-4 rounded-2xl text-base transition-all shadow-md shadow-prestigio-200"
      >
        Continuar →
      </button>
    </div>
